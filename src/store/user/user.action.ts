...
import { Additioninfo, UserData } from "../../utils/firebase/firebase.util";
import {
  Action,
  ActionWithPayload,
  createAction,
...
export type SignUpSuccess = ActionWithPayload<
  ...
  { user: User; additionalDetails: Additioninfo }
>;
...
export const signUpSuccess = withMatcher(
  (user:User , additionalDetails: Additioninfo): SignUpSuccess =>
